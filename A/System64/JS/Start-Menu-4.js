...
var menuItems = [
    ...
    ["||Gameboy /<br>Gameboy Color", "javascript:GBC();", `${iconsAtTwoSizes("joystick", size)}`, "", "", "", "", "", "", "", "",],
    ["||Everything Else", "javascript:Emulator();", `${iconsAtTwoSizes("joystick", size)}`, "", "", "", "", "", "", "", "",],
    ["||<hr class='clear-hr'>"],
    ["||<hr class='clear-hr'>"],
    ["||<hr class='clear-hr'>"],
    ["||<hr class='clear-hr'>"],
