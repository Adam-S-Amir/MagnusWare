...
var menuItems = [
    ...
    ["||Ultimate<br>Doom", "javascript:Doom();", `${iconsAtTwoSizes("Ultimate Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Doom 2", "javascript:DoomII();", `${iconsAtTwoSizes("Doom II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Ultimate<br>Doom 2", "javascript:UD2();", `${iconsAtTwoSizes("Ultimate Doom II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Master Levels<br>for Doom 2", "javascript:Master();", `${iconsAtTwoSizes("Master Levels for Doom II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Brutal Doom 2", "javascript:BDoom2();", `${iconsAtTwoSizes("Brutal Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Doom 64", "javascript:Sixty();", `${iconsAtTwoSizes("Doom 64", size)}`, "", "", "", "", "", "", "", "",],
    ["||Doom 4", "javascript:D4();", `${iconsAtTwoSizes("Doom 4", size)}`, "", "", "", "", "", "", "", "",],
    ["||Duke Nukem", "javascript:Duke();", `${iconsAtTwoSizes("Duke Nukem 3D", size)}`, "", "", "", "", "", "", "", "",],
    ["||FreeDoom", "", `${iconsAtTwoSizes("FreeDoom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Heretic", "javascript:Heretic();", `${iconsAtTwoSizes("Heretic", size)}`, "", "", "", "", "", "", "", "",],
    ["||Heretic 2", "javascript:Heretic2();", `${iconsAtTwoSizes("Heretic II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Hexen", "javascript:Hexen();", `${iconsAtTwoSizes("Hexen", size)}`, "", "", "", "", "", "", "", "",],
    ["||Plutonia", "javascript:Plutonia();", `${iconsAtTwoSizes("The Plutonia Experiment", size)}`, "", "", "", "", "", "", "", "",],
    ["||Plutonia 2", "javascript:Plutonia2();", `${iconsAtTwoSizes("The Plutonia Experiment II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Final Doom", "javascript:TNT();", `${iconsAtTwoSizes("TNT Evilution", size)}`, "", "", "", "", "", "", "", "",],
    ["||Chex Quest", "javascript:Chex1();", `${iconsAtTwoSizes("Chex Quest I", size)}`, "", "", "", "", "", "", "", "",],
    ["||Chex Quest 2", "javascript:Chex2();", `${iconsAtTwoSizes("Chex Quest II", size)}`, "", "", "", "", "", "", "", "",],
    ["||Chex Quest 3", "javascript:Chex3();", `${iconsAtTwoSizes("Chex Quest III", size)}`, "", "", "", "", "", "", "", "",],
    ...
    ["||Quake 2", "javascript:Quake2();", `${iconsAtTwoSizes("Quake II", size)}`, "", "", "", "", "", "", "", "",],
    ["||School Shooter<br>Doom 2", "javascript:Shool();", `${iconsAtTwoSizes("School", size)}`, "", "", "", "", "", "", "", "",],
    ["||Batman Doom", "javascript:BatDoom();", `${iconsAtTwoSizes("Batman Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Mario Doom", "javascript:Dario1();", `${iconsAtTwoSizes("Mario Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Mario Doom 2", "javascript:Dario2();", `${iconsAtTwoSizes("Mario Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||StarWars Doom", "javascript:StarDoom();", `${iconsAtTwoSizes("StarWars Doom", size)}`, "", "", "", "", "", "", "", "",],
    ["||Castle<br>Wolfenstein", "javascript:Castle();", `${iconsAtTwoSizes("Castle Wolfenstein", size)}`, "", "", "", "", "", "", "", "",],
    ["||Wolfenstein 3D", "javascript:Wolf3D();", `${iconsAtTwoSizes("Wolfenstein 3D", size)}`, "", "", "", "", "", "", "", "",],
    ["||Spear of<br>Destiny", "javascript:Spear();", `${iconsAtTwoSizes("Wolfenstein Spear of Destiny", size)}`, "", "", "", "", "", "", "", "",],
    ...
    ["||Doom<br>Zero", "javascript:Zero();", `${iconsAtTwoSizes("Doom Zero", size)}`, "", "", "", "", "", "", "", "",],
    ["||<hr class='clear-hr'>"],
