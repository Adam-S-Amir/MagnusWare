...
clippy.Agent = function (a, b, c) {
    this.path = a, this._queue = new clippy.Queue($.proxy(this._onQueueEmpty, this)), this._el = $('<div class="clippy" id="clippy"></div>').hide(), $(document.body).append(this._el), this._animator = new clippy.Animator(this._el, a, b, c), this._balloon = new clippy.Balloon(this._el), this._setupEvents()
    ...
    _setupEvents: function () {
        $(window).on("resize", $.proxy(this.reposition, this)), this._el.on("mousedown", $.proxy(this._onMouseDown, this)), this._el.on("click", $.proxy(this._onDoubleClick, this))
    },
    ...
    _setup: function () {
        this._balloon = $('<div class="clippy-balloon" id="clippy-2"><div class="clippy-tip"></div><div class="clippy-content"></div></div> ').hide(), this._content = this._balloon.find(".clippy-content"), $(document.body).append(this._balloon)
    },
    reposition: function () {
...
}, clippy.BASE_PATH = "./A/System32/JS/Clippy/agents/", clippy.load = function (a, b, c) {
